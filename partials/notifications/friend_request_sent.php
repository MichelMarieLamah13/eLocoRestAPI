...
<a class="btn btn-primary" href="accept.friend.php?id=<?= $notification->user_id ?>">Accepter</a>
<a class="btn btn-danger" href="delete.friend.php?id=<?= $notification->user_id ?>">Decliner</a>